...
export const buildingApi = {
  ...
  updateStatus: (id, status) => request.put(`/buildings/${id}/status`, null, { params: { status } })
}
...
export const roomApi = {
  ...
  updateStatus: (id, status) => request.put(`/rooms/${id}/status`, null, { params: { status } }),
...
export const studentApi = {
  ...
  bindBed: (id, bedId) => request.post(`/students/${id}/bindBed`, null, { params: { bedId } }),
...
export const repairApi = {
  ...
  handle: (id, data) => request.put(`/repairs/${id}/process`, null, { params: { status: data.status, reply: data.reply } })
}
...
export const announcementApi = {
  ...
  latest: (limit = 5) => request.get('/announcements/latest', { params: { limit } }),
  ...
  updateStatus: (id, status) => request.put(`/announcements/${id}/status`, null, { params: { status } })
}
