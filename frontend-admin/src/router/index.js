...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'users', name: 'Users', component: () => import('../views/Users.vue'), meta: { title: '用户管理', roles: [1] } },
      { path: 'buildings', name: 'Buildings', component: () => import('../views/Buildings.vue'), meta: { title: '楼栋管理', roles: [1, 2] } },
      { path: 'rooms', name: 'Rooms', component: () => import('../views/Rooms.vue'), meta: { title: '房间管理', roles: [1, 2] } },
