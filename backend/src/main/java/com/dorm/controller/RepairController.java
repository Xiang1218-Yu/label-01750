...
public class RepairController {
    ...
    @GetMapping
    @RequireRole({RoleConstants.ADMIN, RoleConstants.DORM_MANAGER}) // 管理员和宿管可查看所有维修申请
    ...
    @GetMapping("/my")
    @RequireRole({RoleConstants.ADMIN, RoleConstants.DORM_MANAGER, RoleConstants.STUDENT}) // 所有角色可查看自己的维修申请
    ...
    @PostMapping
    @RequireRole({RoleConstants.ADMIN, RoleConstants.DORM_MANAGER, RoleConstants.STUDENT}) // 所有角色可提交维修申请
    ...
    @RequireRole({RoleConstants.ADMIN, RoleConstants.DORM_MANAGER}) // 管理员和宿管可处理维修申请
